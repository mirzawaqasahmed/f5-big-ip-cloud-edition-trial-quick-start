...
3. [Setting up a Service Principal Account](https://clouddocs.f5.com/training/community/cloud-edition/html/class02/module5/lab1.html#setting-up-a-service-principal-account) for the Service Scaling Group
